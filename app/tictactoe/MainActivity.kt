...
class MainActivity : AppCompatActivity() {
    ...
    private fun onBtnClick(btn: ImageButton) {
        ...
        if (player1Turn) {
            ...
            btn.setImageResource(R.drawable.round)
        }
        roundCount++
    ...
    private fun getField(btn: ImageButton): Char? {
        ...
        val drwCroos: Drawable? = ResourcesCompat.getDrawable(resources, R.drawable.cross, null)
        val drwRound: Drawable? = ResourcesCompat.getDrawable(resources, R.drawable.round, null)

        return when(drw?.constantState ){
                    drwCroos?.constantState -> 'x'
            drwRound?.constantState -> 'o'
            else -> null
    ...
    private fun updateScore() {
        textViewPlayer1.text = "Player1: $player1Points"
        textViewPlayer2.text = "Player2: $player2Points"
    }
